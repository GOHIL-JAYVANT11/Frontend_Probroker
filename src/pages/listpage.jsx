  ...
  return (
    <div className="p-2 bg-purple-50 min-h-screen">
      ...
      <div className="fixed top-0 left-0 right-0 z-50">
        {/* Main Header */}
        <div className="bg-purple-50 px-2 py-1">
        ...
        <div className="bg-purple-50 border-b border-gray-200 px-2 py-3">
          <div className="flex justify-between items-center">
            ...
            {showFilters && (
          <div className="bg-purple-100 w-3/4 rounded py-2 px-8 border-b border-gray-200">
            ...
            <div className="flex flex-col gap-2">
              <button 
                ...
                className="bg-purple-600 text-white px-3 py-1 rounded-lg text-sm transition-transform duration-300 hover:scale-105"
              >
              ...
              {showFilters && (
                <button 
                  ...
                  className="bg-red-500 text-white px-3 py-1 rounded-lg text-sm transition-transform duration-300 hover:scale-105"
                >
                  Clear All Filters
                </button>
              )}
      ...
      <div className="mt-40"> {/* Increased margin-top to accommodate header and filters */}
        <div className="overflow-x-auto h-[calc(100vh-180px)] relative">
